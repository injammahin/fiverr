    ...
    <>
      ...
      <div className="supplier-page">
        ...
        <div className="filters mb-3" style={{display:"flex",gap:"10px"}}>
          ...
          <button className="btn btn-light">Drafts</button>
          <button className="btn btn-light">To-Do</button>
          <button className="btn btn-light">Paid</button>
          <button className="btn btn-light">Late</button>
