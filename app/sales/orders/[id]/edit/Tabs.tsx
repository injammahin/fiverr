...
export default function Tabs({ active, setActive }: any) {
    ...
    return (
        <div className="editor-tabs mb-3">
            ...
            <button className={tabClasses("recurringOrder")} onClick={() => setActive("recurringOrder")}>
                Recurring Order
            </button>
            <button className={tabClasses("partialInvoices")} onClick={() => setActive("partialInvoices")}>
                Partial Invoices
            </button>
